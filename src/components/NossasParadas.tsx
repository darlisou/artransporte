...
export default function NossasParadas() {
  ...
  useEffect(() => {
    const slides = [
      { badge:"Pará • Ponto de Partida",    title:"BELÉM",       desc:"A capital da Amazônia. Ponto de embarque com cultura, culinária e o maior mercado a céu aberto do mundo.", tag:"Ver o Mercado do Ver-o-Peso",  imgLeft:"https://images.unsplash.com/photo-1596423735880-5f2a689b903e?q=80&w=800&auto=format&fit=crop", objPos:"center 40%" },
      { badge:"Pará • 700km de Belém",  title:"SANTARÉM",    desc:"Onde o Rio Tapajós encontra o Amazonas. Praias de água doce e o famoso Alter do Chão.", tag:"Explorar Alter do Chão",          imgLeft:"https://images.unsplash.com/photo-1602584386319-fa8eb4361c2c?q=80&w=800&auto=format&fit=crop", objPos:"center 60%" },
      { badge:"Pará • O ponto mais estreito",   title:"ÓBIDOS",      desc:"O ponto mais estreito do Rio Amazonas com 1,7km de largura. Fortaleza histórica e arquitetura colonial.", tag:"Conhecer a Fortaleza",             imgLeft:"https://images.unsplash.com/photo-1518182170546-076616fd63e8?q=80&w=800&auto=format&fit=crop", objPos:"center 50%" },
      { badge:"Amazonas • Capital do Boi", title:"PARINTINS",   desc:"A ilha do maior festival folclórico da Amazônia. Bumbá Garantido e Caprichoso encantam o mundo todo.", tag:"Descobrir o Festival",          imgLeft:"https://images.unsplash.com/photo-1564507004663-b6dfb3c824d5?q=80&w=800&auto=format&fit=crop", objPos:"center 45%" },
      { badge:"Amazonas • 270km de Manaus",title:"ITACOATIARA",desc:"Segunda maior cidade do Amazonas. Famosa pelo festival de pesca e pela beleza às margens do Rio Amazonas.", tag:"Sentir a Cidade",                   imgLeft:"https://images.unsplash.com/photo-1629813366051-b58137b2792c?q=80&w=800&auto=format&fit=crop", objPos:"center 55%" },
      { badge:"Amazonas • Destino Final",title:"MANAUS",   desc:"A capital da floresta. Teatro Amazonas, encontro das águas e porta de entrada para a Amazônia profunda.", tag:"Chegar a Manaus",               imgLeft:"https://images.unsplash.com/photo-1584972190367-152e12866657?q=80&w=800&auto=format&fit=crop", objPos:"center 40%" }
    ];
